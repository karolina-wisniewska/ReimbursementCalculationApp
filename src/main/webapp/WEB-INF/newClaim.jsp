    ...
    <div class="row dashboard-nowrap">
        <div class="m-4 p-3 width-medium">
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                <form action="<c:url value="/claim/new"/>" method="post">
                    ...
                    <div class="schedules-content">
                        <c:forEach begin="1" end="5" var="sample">
                            <div class="form-group row">
                                <label for="receipt" class="col-sm-3 label-size col-form-label">
                                    Receipt no. ${sample}
                                </label>
                                <div class="col-sm-3">
                                    <select class="form-control" name="type" id="receipt">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" class="form-control" min="0" step="0.01" value="" id="number" placeholder="Paid amount ($)" name="amount">
                                </div>
                            </div>
                        </c:forEach>
